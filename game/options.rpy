...
init -1 python hide:
    ...
    config.window_title = u"Genji:  Resident Playboy versus the 5C Challenge"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Genji:  Resident Playboy versus the 5C Challenge"
    config.version = "0.0"
...
python early:
    config.save_directory = "Genji Resident Playboy versus the 5C Challenge"
...
init python:
    ...
    build.directory_name = "Genji_Resident_Playboy_versus_the_5C_Challenge"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Genji_Resident_Playboy_versus_the_5C_Challenge"
